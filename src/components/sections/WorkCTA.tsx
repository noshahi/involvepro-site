...
export function WorkCTA({
  headline = "Need similar work for your business?",
  body = "Schedule a meeting and we will review the best path for your website, store, SaaS product, SEO system, or automation workflow.",
}: WorkCTAProps) {
  return (
    <section
    ...
    >
      ...
      <div className="relative mx-auto max-w-[640px]">
        ...
        <p className="mx-auto mt-5 max-w-[460px] text-[15.5px] leading-relaxed text-white/70">{body}</p>
